// Code generated by gengo:objectkind DO NOT EDIT.
package v1
...
func (ProductRequestForPublish) GetKind() string {
	return "Product"
}

func (ProductRequestForPublish) GetPluralizedKind() string {
	return "Products"
}

func (ProductRequestForPublish) GetAPIVersion() string {
	return SchemeGroupVersion.String()
}

func (src *Product) AsProductRequestForPublish() *ProductRequestForPublish {
	dst := pkgruntime.New[ProductRequestForPublish]()
	pkgruntime.CopyObject(dst, src)

	return dst
}

func (src *ProductRequestForPublish) AsProduct() *Product {
	dst := pkgruntime.New[Product]()
	pkgruntime.Copy(dst, src)
...
func (ProductRequestForUnpublish) GetKind() string {
	return "Product"
}

func (ProductRequestForUnpublish) GetPluralizedKind() string {
	return "Products"
}

func (ProductRequestForUnpublish) GetAPIVersion() string {
	return SchemeGroupVersion.String()
}

func (src *Product) AsProductRequestForUnpublish() *ProductRequestForUnpublish {
	dst := pkgruntime.New[ProductRequestForUnpublish]()
	pkgruntime.CopyObject(dst, src)

	return dst
}

func (src *ProductRequestForUnpublish) AsProduct() *Product {
	dst := pkgruntime.New[Product]()
	pkgruntime.Copy(dst, src)
